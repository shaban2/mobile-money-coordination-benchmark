...
k6's constant-arrival-rate executor starts operations at a fixed rate regardless of response time, provided enough pre-allocated virtual users remain [6]. An operation is either a creation attempt or a status read, not necessarily a new transfer. The repeating 100-operation schedule contains 76 unique creations, four idempotent creation replays, and 20 status reads. Thus replays are 5% of creation attempts and 4% of all operations; these proportions are benchmark choices rather than estimates from customer traffic.
...
[16] S. Lubanga, “Mobile-money coordination benchmark: Code, redacted evidence, analysis and paper,” v1.2.3, Zenodo, 2026. https://doi.org/10.5281/zenodo.22933798 (all versions). https://github.com/shaban2/mobile-money-coordination-benchmark
